        ...
        <section className="w-full overflow-hidden rounded-[32px] bg-white shadow-xl shadow-slate-900/6 ring-1 ring-slate-100">
          <div className="px-5 py-7 sm:px-8 sm:py-8">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[22px] bg-slate-50 text-[#047857] ring-1 ring-slate-100">
          ...
          <div className="px-5 py-5 sm:px-8 sm:py-7">
            <div className="rounded-[28px] bg-slate-50 p-4 ring-1 ring-slate-100 sm:p-5">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-white text-[#047857] ring-1 ring-emerald-100">
              ...
              <div className="mt-5 space-y-2">
                {guideContent.checks.map((check) => (
                  ...
                  >
                    <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#10B981] text-white">
            ...
            <div className="mt-5 rounded-[24px] bg-emerald-50/80 px-4 py-4 ring-1 ring-emerald-100 sm:px-5">
              <div className="flex items-start gap-3">
                <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-[#047857] ring-1 ring-emerald-100">
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-[1fr_1.5fr]">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="flex h-14 items-center justify-center gap-2 rounded-full bg-[#10B981] px-6 text-base font-bold text-white shadow-lg shadow-emerald-900/20 transition hover:-translate-y-0.5 hover:bg-[#059669] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:shadow-none disabled:hover:translate-y-0"
              >
                확인했어요
          ...
          <div className="w-full max-w-[420px] rounded-[30px] bg-white px-5 py-5 shadow-[0_28px_90px_-34px_rgba(15,23,42,0.7)] ring-1 ring-slate-100 sm:px-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="flex h-12 items-center justify-center gap-2 rounded-full bg-[#10B981] text-sm font-bold text-white shadow-lg shadow-emerald-900/20 transition hover:bg-[#059669] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:shadow-none"
              >
                {isSubmitting ? (
                  <>
                    <Icon
