          ...
          <div className="px-5 py-6 sm:px-8 sm:py-8">
            <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_220px] md:items-center">
              ...
              <div className="relative hidden md:block">
                <div className="rounded-[28px] bg-linear-to-br from-[#10B981] to-[#047857] p-5 text-white shadow-xl shadow-emerald-900/20">
              ...
              {[
                ...
                >
                  <div className="flex items-start gap-3 sm:block">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-emerald-50 text-[#047857]">
