...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#d6d6d6]/60 bg-white/90 shadow-[0_1px_0_rgba(15,23,42,0.02)] backdrop-blur-xl">
      <div className="relative mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        >
          <span className="relative inline-flex h-9 w-9 items-center justify-center rounded-[14px] bg-[#f5f5f7] shadow-sm ring-1 ring-[#d6d6d6]/80">
            <img
            ...
            return (
              <button
                ...
                className={[
                  ...
                  isActive
                    ? "bg-[#e2e2e5] text-[#1d1d1f] ring-1 ring-[#d6d6d6]/80"
                    : "text-[#474747] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]",
                ].join(" ")}
              >
                {item.label}
              </button>
          ...
          {isLoggedIn ? (
            <>
              <button
                ...
                className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-[#707070] transition hover:bg-[#f5f5f7] hover:text-[#1d1d1f]"
                aria-label="알림"
              >
              ...
              <button
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#f5f5f7] text-[#474747] ring-1 ring-[#d6d6d6]/80 transition hover:bg-[#e2e2e5] hover:text-[#1d1d1f]"
                aria-label="마이페이지"
              >
            ...
            <Link
              to="/log-in"
              onClick={scrollToTop}
              className="inline-flex h-10 items-center justify-center rounded-full bg-[#0071e3] px-5 text-sm font-bold text-white shadow-sm transition hover:bg-[#0066cc] active:scale-95"
            >
              시작하기
            </Link>
          )}
